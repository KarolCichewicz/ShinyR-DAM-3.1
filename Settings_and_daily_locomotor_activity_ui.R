...
fluidPage(  
  fluidRow(
    column(12, 
           ...
           tags$h4(div(HTML("v3.1 <q>Refresh")), align="center"),
           tags$h3("Program analyzing locomotor activity in TriKinetics Drosophila Activity Monitor System", align = "center"),
           
           #tags$h4("(Important message about the future of ShinyR-DAM from Karol)[message.html]", align = "center"),
           
           tags$div(
           tags$a(href="Message2.html", 
                  "Important message about the future of ShinyR-DAM from Karol"), style = "font-size: 26px;", align = "center"),
      ...
      column(4,
             conditionalPanel(
               ...
               dateRangeInput('dateRange',
                              ...
                              #start = as.Date("23-06-2017", "%d-%m-%Y"), end = as.Date("27-06-2017", "%d-%m-%Y"),
                              separator = " - "
                              )
             ),
             ...
             conditionalPanel(
               ...
               dateRangeInput('dateRange1',
                              ...
                              #start = as.Date("28-06-2017", "%d-%m-%Y"), end = as.Date("02-07-2017", "%d-%m-%Y"),
                              separator = " - "
