column(8,
       tags$body(
         ...
         tags$br(),
         tags$div(
           tags$p(strong('How to cite ShinyR-DAM:')), 
           style = "font-size: 19px"),
         
         #tags$div(
         # tags$p(div(HTML("Cichewicz K. & Hirsh J., ShinyR-DAM: A program analyzing <i>Drosophila</i> activity, sleep, and circadian rhythms, <i>Commun. Biol.</i> 1, 25 (2018)"))), 
         #  style = "font-size: 19px"),
         
         tags$div(
           tags$a(href="https://www.nature.com/articles/s42003-018-0031-9", 
                  "Cichewicz K. & Hirsh J., ShinyR-DAM: A program analyzing Drosophila activity, sleep, and circadian rhythms, Commun. Biol. 1, 25 (2018)"), style = "font-size: 19px"),
         
         
         h3(strong('Contact information:')),
         tags$div(
           tags$p('Karol Cichewicz - kc.bioinformatics@gmail.com'), 
         ...
         tags$div(
           tags$a("Supplementary Information.pdf",target="_blank",href="Supplementary_Information.pdf"), style = "font-size: 19px"),
         
         
         tags$div(
           tags$a(href="https://figshare.com/articles/ShinyR-DAM_Supplementary_Files/5858343", 
                  " Supplementary Information Dataset"), style = "font-size: 19px"),
    ...
    tags$div(
      tags$a(href="https://figshare.com/articles/ShinyR-DAM_Supplementary_Files/5858343", 
       ...
       tags$div(
         ...
         tags$h3(strong('3.1')),
         tags$ul(
           tags$li("kmisc::melt_ was replaced by supported functions"),
           tags$li("Community-funding was proposed")
         ),
